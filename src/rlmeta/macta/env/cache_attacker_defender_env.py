...
class CacheAttackerDefenderEnv(gym.Env):
    ...
    def compute_reward(self, action, reward, opponent_done, opponent_attack_success=False):
        ...
        bin_rep = bin_rep = format(action["detector"], '08b')  
    ...
    def step(self, action):
        ...
        if action["detector"] > 15 :
            ...
            # bin_rep = bin_rep = format(action["detector"], '04b') #need only this for the correct attack-defender  
            # detector_action = str(bin_rep)
