...
from rlmeta.core.server import Server, Server
...
def main(cfg):
    ...
    servers = Server([m_server, r_server, c_server, md_server, rd_server])
    # =========================================================================
    ...
    t_b_fac = SpecAgent(cfg.env_config,
                               cfg.trace_files,
                               cfg.trace_limit,
                               legacy_trace_format=cfg.legacy_trace_format)
    e_b_fac = SpecAgent(cfg.env_config,
                               cfg.trace_files,
                               cfg.trace_limit,
                               legacy_trace_format=cfg.legacy_trace_format)
