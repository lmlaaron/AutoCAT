...
#@hydra.main(config_path="./config", config_name="ppo_anti")
...
def main(cfg):
    ...
    train_model = CachePPOLSTMModel(**cfg.model_config).to(
        cfg.train_device)
    ...
    train_model_d = CachePPOLSTMModel(**cfg.model_config).to(
        cfg.train_device_d)
    ...
    loops = LoopList([ta_loop, ea_loop])
