# a textbook prime probe attacker that serve as the agent which can have high reward for the cache guessing game
# modified for 1set-8way scenario. used cache setting are as below:
