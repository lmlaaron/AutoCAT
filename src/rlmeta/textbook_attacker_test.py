...
class TextbookAgent():
    ...
    def __init__(self, env_config):
        ...
        if "cache_configs" in env_config:
            ...
            attacker_addr_e = env_config["attacker_addr_e"] if "attacker_addr_e" in env_config else self.cache_size * 2 -1 # 2*N*M-1
            victim_addr_s = env_config["victim_addr_s"] if "victim_addr_s" in env_config else 0
            victim_addr_e = env_config["victim_addr_e"] if "victim_addr_e" in env_config else self.cache_size - 1 # N*M-1
